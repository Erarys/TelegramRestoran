...
async def auto_fill(message: Message):
    dt = {
        "Гуйру": 2000,
        "Суйру": 2000,
        "Домашний лагман": 2000,
        "Гуйру цомян": 2000,
        "Дин-дин": 2000,
        "Лагман с ребрами": 2000,
        "Могру": 2000,
        "Хаухуа": 2000,
        "Мошру": 2000,
        "Фирменный лагман \"Арыс\"": 2000,
        ...
        "Фри с мясом": 2000,
        "Свежий салат": 2000,
        "Пекинский салат": 2000,
        "Хрустящий баклажан": 2000,
        "Ачучук": 2000,
        "Coca-Cola 2л": 1000,
        "Fanta 1л": 700,
        "Coca-Cola 1л": 700,
    ...
    for food_name, price in dt.items():
        ...
        if is_exist:
            await message.answer(f"{food_name} уже существует, сначала удалите старый 🚨")
        else:
            await message.answer("Продукт успешно добавлен")